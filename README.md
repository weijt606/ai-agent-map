...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(↑) | [mattpocock/skills](https://github.com/mattpocock/skills) | 144.5k | +11,147 | Watchlist (Skills Wave) | Retook the gain lead with the window's biggest surge — Matt Pocock's curated `.claude/skills` directory cleared 144k |
| #2&nbsp;(↑) | [Superpowers](https://github.com/obra/superpowers) | 237.6k | +6,649 | In scope · [profile](agents/superpowers.md) | The agentic skills framework crossed 237k — the wave's framework anchor keeps compounding |
| #3&nbsp;(↑) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 201.7k | +5,622 | In scope · [profile](agents/hermes-agent.md) | Climbed back up the gain table and broke 200k — the in-scope absolute leader |
...
| #5&nbsp;(↑) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 54.1k | +3,091 | In scope · [profile](agents/codegraph.md) | Steady climb — the pre-indexed code knowledge graph cleared 54k |
| #6&nbsp;(↑) | [anthropics/skills](https://github.com/anthropics/skills) | 154.7k | +2,531 | Watchlist (Skills Wave canonical) | Anthropic's own reference `.claude/skills` repo — the upstream source; steady growth past 154k |
| #7&nbsp;(↑) | [Pi](https://github.com/earendil-works/pi) | 65.3k | +1,737 | In scope · [profile](agents/pi.md) | Steady climb — the Earendil-owned harness crossed 65k |
| #8 | [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) | 34.1k | +1,716 | Watchlist (Skills Wave) | Still a fast-growing curated skills collection — academic research pipeline for Claude Code crossed 34k |
| #9&nbsp;(new) | [Codex CLI](https://github.com/openai/codex) | 93.4k | +1,616 | In scope · [profile](agents/codex.md) | Re-entered the gain table — OpenAI's Codex CLI cleared 93k |
| #10 | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 88.3k | +1,396 | Out of scope | Vertical finance-research multi-agent system — high total, steady gain, but out of scope as a domain vertical |

- Heat is useful for discovery, not for selection by itself.
- The headline this window is [mattpocock/skills](https://github.com/mattpocock/skills): the curated `.claude/skills` directory posted the biggest gain of any tracked repo (+11.1k), retaking the #1 gain spot and clearing 144k.
- Last window's breakout, [MiMoCode](agents/mimocode.md), cooled hard — after roughly tripling the prior window it added only ~1.0k (9.6k → 10.6k) and dropped off the gain top 10. Single-window breakouts rarely sustain; the profile stays.
- The `.claude/skills` wave still holds five of the top ten (`mattpocock/skills`, `Superpowers`, `addyosmani/agent-skills`, `anthropics/skills`, `academic-research-skills`), but the lead rotated within it: [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) slipped from #1 to #4 as `mattpocock/skills` surged. Policy unchanged: curated collections are tracked as Skills Wave entries, the framework end is covered through [Superpowers](agents/superpowers.md).
- [Codex CLI](agents/codex.md) re-entered the gain table at #9 (+1.6k, past 93k); [Hermes Agent](agents/hermes-agent.md) climbed back to #3 and broke 200k.
- **New-inclusion scan** turned up no new in-scope surface this window. The biggest fresh repos are curated skill collections that stay on the watchlist — [op7418/guizang-social-card-skill](https://github.com/op7418/guizang-social-card-skill) (4.0k, a Claude Code / Codex skill for Xiaohongshu / WeChat cards) and [ruvnet/agent-harness-generator](https://github.com/ruvnet/agent-harness-generator) (0.3k, a meta-harness scaffolder, adjacent to [OpenHarness](agents/openharness.md)) — neither clears the in-scope bar yet.
- [OpenClaw](agents/openclaw.md) remains the absolute leader at 380.3k stars (+1.1k); it is profiled but stays out of the gain-ranked table because reliable week-over-week deltas for a project this large are noisy.
- Continuing to grow but outside the top 10 by gain: [Ruflo](agents/ruflo.md) 61.2k (+1.2k), [MiMoCode](agents/mimocode.md) 10.6k (+1.0k), [financial-services](https://github.com/anthropics/financial-services) 32.4k (+0.9k), [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) 29.2k (+0.7k), [agentmemory](https://github.com/rohitg00/agentmemory) 23.9k (+0.6k), [jcode](https://github.com/1jehuang/jcode) 7.7k (+0.6k), [openhuman](agents/openhuman.md) 32.9k (+0.4k), [CLI-Anything](agents/cli-anything.md) 43.7k (+0.4k), [CodeWhale](agents/codewhale.md) 38.9k (+0.3k), [Kimi Code](agents/kimi-code.md) 2.7k (+0.2k), [12-factor-agents](https://github.com/humanlayer/12-factor-agents) 23.5k (+0.1k), [CoStrict](agents/costrict.md) 4.2k (flat).
