...
> **Last updated:** 2026-07-08 · **Snapshot window:** 2026-07-02 → 2026-07-08 (gain since last update, ~6 days, approximate) · **Star counts:** checked at update time
...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 160.5k | +6,609 | Watchlist (Skills Wave) | Held the gain lead for a third straight window — Matt Pocock's curated `.claude/skills` directory cleared 160k |
| #2&nbsp;(=) | [Superpowers](https://github.com/obra/superpowers) | 249.4k | +5,343 | In scope · [profile](agents/superpowers.md) | The agentic skills framework nears 250k — the wave's framework anchor keeps compounding |
| #3&nbsp;(↑) | [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | 72.8k | +4,296 | Watchlist (Skills Wave) | Biggest riser this window — climbed three spots from #6, Addy Osmani's curated agent-skills collection cleared 72k |
| #4&nbsp;(↓) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 211.3k | +3,572 | In scope · [profile](agents/hermes-agent.md) | Cooled a step to #4 — the in-scope absolute leader cleared 211k |
| #5&nbsp;(↓) | [anthropics/skills](https://github.com/anthropics/skills) | 159.4k | +1,779 | Watchlist (Skills Wave canonical) | Slipped one spot — Anthropic's own reference `.claude/skills` repo, the upstream source, neared 160k |
| #6&nbsp;(↓) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 58.5k | +1,576 | In scope · [profile](agents/codegraph.md) | Steady climb — the pre-indexed code knowledge graph cleared 58k |
| #7&nbsp;(↑) | [Pi](https://github.com/earendil-works/pi) | 68.6k | +1,431 | In scope · [profile](agents/pi.md) | Climbed one spot — the Earendil-owned harness cleared 68k |
| #8&nbsp;(↓) | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 91.8k | +1,424 | Out of scope | Vertical finance-research multi-agent system slipped one spot and cleared 91k — high total, steady gain, but out of scope as a domain vertical |
| #9&nbsp;(↑) | [Codex CLI](https://github.com/openai/codex) | 96.2k | +1,180 | In scope · [profile](agents/codex.md) | Climbed one spot — OpenAI's Codex CLI neared 96k |
| #10&nbsp;(↓) | [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) | 36.9k | +948 | Watchlist (Skills Wave) | Slipped one spot but kept climbing — academic research pipeline for Claude Code cleared 36k |

- Heat is useful for discovery, not for selection by itself.
- The headline this window is a curated-skills rotation: [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) was the biggest riser (+4.3k), climbing three spots from #6 to #3 and re-heating the curated end. Above it [mattpocock/skills](https://github.com/mattpocock/skills) held the #1 gain spot for a third straight window (+6.6k, past 160k), while [Hermes Agent](agents/hermes-agent.md) and [anthropics/skills](https://github.com/anthropics/skills) each cooled a step. Still no breakout — the top of the table keeps compounding.
- The `.claude/skills` wave still holds five of the top ten (`mattpocock/skills`, `Superpowers`, `addyosmani/agent-skills`, `anthropics/skills`, `academic-research-skills`). Policy unchanged: curated collections are tracked as Skills Wave entries, the framework end is covered through [Superpowers](agents/superpowers.md).
- [TradingAgents](https://github.com/TauricResearch/TradingAgents) slipped to #8 (+1.4k, past 91k) but stays out of scope as a finance-research vertical; [Codex CLI](agents/codex.md) ticked up to #9 (near 96k) and [Pi](agents/pi.md) to #7 (past 68k).
- **New-inclusion scan** turned up no new in-scope surface this window. The freshest and largest new repos are [langchain-ai/openwiki](https://github.com/langchain-ai/openwiki) (9.6k, TypeScript — a CLI that writes and maintains agent-generated docs) and [vercel/eve](https://github.com/vercel/eve) (3.3k, TypeScript — Vercel's agent-building framework); both join the watchlist alongside the carried-over [op7418/guizang-social-card-skill](https://github.com/op7418/guizang-social-card-skill) (4.8k), [JimLiu/baoyu-design](https://github.com/JimLiu/baoyu-design) (2.5k) and [tigicion/dao-code](https://github.com/tigicion/dao-code) (1.6k). None clears the in-scope bar yet.
- [OpenClaw](agents/openclaw.md) remains the absolute leader at 382.2k stars (+0.7k); it is profiled but stays out of the gain-ranked table because reliable week-over-week deltas for a project this large are noisy.
- Continuing to grow but outside the top 10 by gain: [Ruflo](agents/ruflo.md) 63.5k (+0.9k), [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) 30.5k (+0.5k), [CLI-Anything](agents/cli-anything.md) 45.0k (+0.5k), [openhuman](agents/openhuman.md) 34.4k (+0.4k), [MiMoCode](agents/mimocode.md) 11.6k (+0.4k), [agentmemory](https://github.com/rohitg00/agentmemory) 24.8k (+0.3k), [financial-services](https://github.com/anthropics/financial-services) 33.2k (+0.3k), [CodeWhale](agents/codewhale.md) 39.6k (+0.3k), [jcode](https://github.com/1jehuang/jcode) 8.2k (+0.1k), [Kimi Code](agents/kimi-code.md) 3.0k (+0.1k), [12-factor-agents](https://github.com/humanlayer/12-factor-agents) 24.0k (+0.1k), [CoStrict](agents/costrict.md) 4.3k (flat).
