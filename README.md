...
- No new in-scope profiles this update — it is a heat refresh. Last window's breakout ([codegraph](agents/codegraph.md)) cooled from +21k to +9.7k but is still climbing; [Hermes Agent](agents/hermes-agent.md) retook the gain lead.
