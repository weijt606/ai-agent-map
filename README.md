...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 214.3k | +10,285 | Watchlist (Skills Wave) | An eighth straight window at #1, past **214k** — the gain finally eased (−8%), and it still out-gains #2 by 2.2× |
| #2&nbsp;(new) | [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | 86.4k | +4,657 | Watchlist (Skills Wave) | Off the table last week at +945, now #2 on a **4.9× jump** — the sharpest re-acceleration this board has recorded |
| #3&nbsp;(↓) | [Pi](https://github.com/earendil-works/pi) | 88.1k | +4,139 | In scope · [profile](agents/pi.md) | Slipped one on a flat gain (+4,263 → +4,139) — it was passed, not slowed; cleared 88k |
| #4&nbsp;(↓) | [Superpowers](https://github.com/obra/superpowers) | 270.9k | +4,074 | In scope · [profile](agents/superpowers.md) | Down one, also on a flat gain — cleared 270k as the wave's framework anchor |
| #5&nbsp;(↓) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 229.2k | +3,492 | In scope · [profile](agents/hermes-agent.md) | Down one as the gain cooled 10% — still the in-scope absolute leader, past 229k |
| #6&nbsp;(new) | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 97.7k | +2,043 | Out of scope (finance-research vertical) | Its biggest window on record (+785 → +2,043, 2.6×), closing on 100k — tracked, but still not an in-scope agent surface |
| #7&nbsp;(=) | [anthropics/skills](https://github.com/anthropics/skills) | 168.4k | +1,990 | Watchlist (Skills Wave canonical) | Held #7 with the gain up 28% — Anthropic's reference `.claude/skills` repo cleared 168k |
| #8&nbsp;(new) | [QM](https://github.com/yc-software/qm) | 13.2k | +1,751 | In scope · [profile](agents/qm.md) | First full window since being profiled: **+15% of its own size** (11.4k → 13.2k), straight onto the table |
| #9&nbsp;(↓) | [Codex CLI](https://github.com/openai/codex) | 105.4k | +1,378 | In scope · [profile](agents/codex.md) | Down three as the gain gave back last window's rebound (−28%) — cleared 105k |
| #10&nbsp;(↓) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 66.0k | +1,335 | In scope · [profile](agents/codegraph.md) | Down two, gain off 14%, holding the last seat by 53 stars — the pre-indexed code knowledge graph cleared 66k |
...
- **[mattpocock/skills](https://github.com/mattpocock/skills) takes an eighth straight #1** (214.3k, +10,285) — but this is its first deceleration in three windows (−8%). It still out-gains everything below #5 on this table combined, so read the dip as easing, not turning.
- **The frozen top six broke.** Last week #1–#6 were identical to the week before, a first for this board. This week four of those six moved: [Pi](agents/pi.md), [Superpowers](agents/superpowers.md) and [Hermes Agent](agents/hermes-agent.md) each slid a seat, and [Codex CLI](agents/codex.md) fell three. Note *why* — Pi and Superpowers posted essentially flat gains (−3% and −2%). They were passed, not slowed.
- **[jcode](agents/jcode.md) reversed hard, and last week's read was too generous.** The "fastest riser by proportion" (+3,163) fell to **+1,282, a 59% drop**, and off the table entirely from #5. Two windows at 2–3k/week was the tail of a launch curve flattening, not a new baseline. The profile still stands; the trajectory call does not.
- **[TradingAgents](https://github.com/TauricResearch/TradingAgents) posts its biggest window ever and still is not in scope** (+2,043 to 97.7k, up 2.6× from +785). It enters at #6 because the table ranks gain, not fit — it remains a finance-research multi-agent framework, tracked but unprofiled. This is the clearest case yet for the line at the top of this section.
- **[QM](agents/qm.md)'s first full window backs the pickup**: +1,751 to 13.2k, roughly 15% of its own size, entering at #8 one week after being profiled. [Open Code Review](agents/open-code-review.md) (+1,242) and [Omnigent](agents/omnigent.md) (+503) post their first deltas just off the table.
...
- Just off the table: [jcode](agents/jcode.md) 17.2k (+1,282), [Open Code Review](agents/open-code-review.md) 20.2k (+1,242) and [academic-research-skills](https://github.com/Imbad0202/academic-research-skills) 42.1k (+1,106) — the three of them inside 176 stars, all within reach of #10's +1,335.
...
- **First real deltas for last window's pickups**: [Open Code Review](agents/open-code-review.md) +1,242 (20.2k), [Omnigent](agents/omnigent.md) +503 (8.6k) and [Langfuse](agents/langfuse.md) +387 (32.9k) all now carry a comparable 7-day figure, alongside [QM](agents/qm.md) at #8. Four profiles added in two weeks, four of them growing — none needs a caveat next window.
- **[AutoGPT](agents/autogpt.md) woke up**: +723 to 186.5k, against +79 last window — a 9× jump off a very low base. One window is not a trend, but it is the largest proportional move outside the top ten and worth watching.
- **[Grok Build](agents/grok-build.md) keeps decelerating**: +551 to 24.7k, down 41% from its first comparable window (+940). Two windows of consistent decay past the launch spike, which is the expected shape.
