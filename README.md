...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 153.9k | +9,323 | Watchlist (Skills Wave) | Held the gain lead for a second straight window — Matt Pocock's curated `.claude/skills` directory cleared 153k |
| #2&nbsp;(=) | [Superpowers](https://github.com/obra/superpowers) | 244.0k | +6,392 | In scope · [profile](agents/superpowers.md) | The agentic skills framework crossed 244k — the wave's framework anchor keeps compounding |
| #3&nbsp;(=) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 207.7k | +5,918 | In scope · [profile](agents/hermes-agent.md) | Steady third — the in-scope absolute leader cleared 207k |
| #4&nbsp;(↑) | [anthropics/skills](https://github.com/anthropics/skills) | 157.6k | +2,885 | Watchlist (Skills Wave canonical) | Climbed two spots — Anthropic's own reference `.claude/skills` repo, the upstream source, past 157k |
| #5&nbsp;(=) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 57.0k | +2,832 | In scope · [profile](agents/codegraph.md) | Steady climb — the pre-indexed code knowledge graph cleared 57k |
...
| #7&nbsp;(↑) | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 90.4k | +2,009 | Out of scope | Vertical finance-research multi-agent system climbed three spots and cleared 90k — high total, steady gain, but out of scope as a domain vertical |
| #8&nbsp;(↓) | [Pi](https://github.com/earendil-works/pi) | 67.2k | +1,819 | In scope · [profile](agents/pi.md) | Steady climb — the Earendil-owned harness crossed 67k |
| #9&nbsp;(↓) | [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) | 35.9k | +1,728 | Watchlist (Skills Wave) | Still a fast-growing curated skills collection — academic research pipeline for Claude Code neared 36k |
| #10&nbsp;(↓) | [Codex CLI](https://github.com/openai/codex) | 95.1k | +1,678 | In scope · [profile](agents/codex.md) | Held the gain table — OpenAI's Codex CLI cleared 95k |

- Heat is useful for discovery, not for selection by itself.
- The headline this window is stability at the top: [mattpocock/skills](https://github.com/mattpocock/skills) held the #1 gain spot for a second straight window (+9.3k, past 153k), and [Superpowers](agents/superpowers.md) and [Hermes Agent](agents/hermes-agent.md) held #2 and #3. No breakout this window — the top of the table simply kept compounding.
- The `.claude/skills` wave still holds five of the top ten (`mattpocock/skills`, `Superpowers`, `anthropics/skills`, `addyosmani/agent-skills`, `academic-research-skills`). Within it, [anthropics/skills](https://github.com/anthropics/skills) climbed to #4 while [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) cooled further to #6. Policy unchanged: curated collections are tracked as Skills Wave entries, the framework end is covered through [Superpowers](agents/superpowers.md).
- [TradingAgents](https://github.com/TauricResearch/TradingAgents) re-entered higher at #7 (+2.0k, past 90k) but stays out of scope as a finance-research vertical; [Codex CLI](agents/codex.md) held the table at #10 (past 95k).
- **New-inclusion scan** turned up no new in-scope surface this window. The freshest candidates are a new DeepSeek-V4 terminal coding CLI — [tigicion/dao-code](https://github.com/tigicion/dao-code) (1.2k, TypeScript) — and [JimLiu/baoyu-design](https://github.com/JimLiu/baoyu-design) (2.2k, Claude Design packaged as an Agent Skill); both join the watchlist alongside [op7418/guizang-social-card-skill](https://github.com/op7418/guizang-social-card-skill) (4.4k). None clears the in-scope bar yet.
- [OpenClaw](agents/openclaw.md) remains the absolute leader at 381.4k stars (+1.2k); it is profiled but stays out of the gain-ranked table because reliable week-over-week deltas for a project this large are noisy.
- Continuing to grow but outside the top 10 by gain: [Ruflo](agents/ruflo.md) 62.6k (+1.3k), [openhuman](agents/openhuman.md) 34.1k (+1.2k), [CLI-Anything](agents/cli-anything.md) 44.5k (+0.8k), [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) 29.9k (+0.7k), [MiMoCode](agents/mimocode.md) 11.3k (+0.7k), [agentmemory](https://github.com/rohitg00/agentmemory) 24.5k (+0.6k), [financial-services](https://github.com/anthropics/financial-services) 32.9k (+0.5k), [12-factor-agents](https://github.com/humanlayer/12-factor-agents) 23.9k (+0.4k), [jcode](https://github.com/1jehuang/jcode) 8.1k (+0.4k), [CodeWhale](agents/codewhale.md) 39.3k (+0.4k), [Kimi Code](agents/kimi-code.md) 2.9k (+0.2k), [CoStrict](agents/costrict.md) 4.3k (flat).
