...
| --- | --- | --- | --- | --- | --- |
| #1 (↑) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 190.5k | +13,900 | In scope · [profile](agents/hermes-agent.md) | Seventh consecutive window of growth — the in-scope absolute leader retook the gain lead and cleared 190k |
| #2 | [mattpocock/skills](https://github.com/mattpocock/skills) | 125.1k | +10,400 | Watchlist (Skills Wave) | Still accelerating — Matt Pocock's curated `.claude/skills` directory added another ~10k and cleared 125k |
| #3 (↓) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 47.2k | +9,700 | In scope · [profile](agents/codegraph.md) | Cooling from last window's breakout but still climbing fast — the pre-indexed code knowledge graph cleared 47k as agent-context infrastructure keeps drawing demand |
| #4 | [Superpowers](https://github.com/obra/superpowers) | 224.3k | +8,800 | In scope · [profile](agents/superpowers.md) | The agentic skills framework crossed 224k — the wave's framework anchor keeps compounding |
| #5 (↑) | [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | 53.4k | +5,700 | Watchlist (Skills Wave) | Jumped into the top tier — Addy Osmani's curated agent-skills collection accelerated past 53k |
| #6 (↓) | [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) | 30.1k | +4,100 | Watchlist (Skills Wave) | Still a fast-growing curated skills collection — academic research pipeline for Claude Code crossed 30k |
| #7 (↓) | [anthropics/skills](https://github.com/anthropics/skills) | 149.3k | +3,800 | Watchlist (Skills Wave canonical) | Anthropic's own reference `.claude/skills` repo — the upstream source; steady growth approaching 150k |
| #8 (↑) | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 85.1k | +3,000 | Out of scope | Vertical finance-research multi-agent system — high total, steady gain, but out of scope as a domain vertical |
| #9 (↓) | [Pi](https://github.com/earendil-works/pi) | 61.7k | +2,900 | In scope · [profile](agents/pi.md) | Steady climb — the Earendil-owned harness crossed 61k |
| #10 (new) | [Codex CLI](https://github.com/openai/codex) | 90.4k | +2,500 | Out of scope (covered via [Codex](agents/codex.md)) | OpenAI's open-source coding CLI crossed 90k — the product surface is profiled as [Codex](agents/codex.md) |

- Heat is useful for discovery, not for selection by itself.
- Heat table is a pure gain refresh; last window's breakout ([codegraph](agents/codegraph.md)) cooled from +21k to +9.7k but is still climbing, and [Hermes Agent](agents/hermes-agent.md) retook the gain lead.
- **Two new in-scope profiles — vendor-official coding CLIs:** [Kimi Code](agents/kimi-code.md) (`MoonshotAI/kimi-code`, Moonshot's Kimi-native successor to kimi-cli) and [MiMoCode](agents/mimocode.md) (`XiaomiMiMo/MiMo-Code`, Xiaomi's official MiMo CLI with built-in cross-session memory, launched 2026-06-10, ~3.1k stars in days). Both join the Direct execution route; the terminal coding-CLI field now has its own [comparison page](comparisons/coding-cli-agents.md). MiMoCode is Xiaomi's first-party CLI and is distinct from the community [CodeWhale](agents/codewhale.md) TUI that merely wraps DeepSeek + MiMo.
- The `.claude/skills` wave re-broadened: five of the top ten are skills collections or frameworks (`mattpocock/skills`, `Superpowers`, `addyosmani/agent-skills`, `academic-research-skills`, `anthropics/skills`), up from four last window, with [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) jumping into the top five. Policy unchanged: curated collections are tracked as Skills Wave entries, the framework end is covered through [Superpowers](agents/superpowers.md).
- [OpenClaw](agents/openclaw.md) remains the absolute leader at 378.1k stars (+1.9k); it is profiled but stays out of the gain-ranked table because reliable week-over-week deltas for a project this large are noisy.
- Continuing to grow but outside the top 10 by gain: [agentmemory](https://github.com/rohitg00/agentmemory) 22.3k (+1.7k), [Ruflo](agents/ruflo.md) 58.9k (+1.5k), [financial-services](https://github.com/anthropics/financial-services) 30.8k (+1.4k), [CodeWhale](agents/codewhale.md) 38.0k (+1.4k), [openhuman](agents/openhuman.md) 31.5k (+1.1k), [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) 27.9k (+1.0k), [CLI-Anything](agents/cli-anything.md) 42.7k (+0.9k), [12-factor-agents](https://github.com/humanlayer/12-factor-agents) 23.2k (+0.3k), [jcode](https://github.com/1jehuang/jcode) 7.0k (+0.2k).
