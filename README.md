...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 192.9k | +11,033 | Watchlist (Skills Wave) | Held the gain lead for a sixth straight window — Matt Pocock's curated `.claude/skills` directory cleared 192k, though its jump cooled from last window's record |
| #2&nbsp;(↑) | [Pi](https://github.com/earendil-works/pi) | 79.7k | +4,286 | In scope · [profile](agents/pi.md) | Climbed to #2 and neared 80k — the Earendil-owned harness was the steadiest gainer in the top five |
| #3&nbsp;(↓) | [Superpowers](https://github.com/obra/superpowers) | 262.7k | +3,409 | In scope · [profile](agents/superpowers.md) | Slipped to #3 as its gain fell by a third, but crossed 262k — still the wave's framework anchor |
| #4&nbsp;(=) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 221.9k | +3,057 | In scope · [profile](agents/hermes-agent.md) | Steady at #4 for a third straight window — the in-scope absolute leader cleared 221k |
| #5&nbsp;(↑) | [jcode](https://github.com/1jehuang/jcode) | 12.8k | +2,156 | In scope · [profile](agents/jcode.md) | Rose two spots in its first full window as a profile — the Rust multi-session harness cleared 12.7k |
| #6&nbsp;(↓) | [Codex CLI](https://github.com/openai/codex) | 102.1k | +1,498 | In scope · [profile](agents/codex.md) | Eased to #6 as its gain halved post-100k — OpenAI's Codex CLI cleared 102k |
| #7&nbsp;(↑) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 63.1k | +1,464 | In scope · [profile](agents/codegraph.md) | Up one to #7 — the pre-indexed code knowledge graph cleared 63k |
| #8&nbsp;(↓) | [anthropics/skills](https://github.com/anthropics/skills) | 164.8k | +1,439 | Watchlist (Skills Wave canonical) | Slipped two spots as its gain nearly halved — Anthropic's reference `.claude/skills` repo cleared 164k |
| #9&nbsp;(↑) | [Kimi Code](https://github.com/MoonshotAI/kimi-code) | 5.5k | +997 | In scope · [profile](agents/kimi-code.md) | Up one to #9 — Moonshot's vendor-official Kimi-native CLI cleared 5.5k |
| #10&nbsp;(new) | [n8n](https://github.com/n8n-io/n8n) | 198.4k | +973 | In scope · [profile](agents/n8n.md) | First appearance on this table — the workflow-automation runtime neared 198.5k and took the last seat by 8 stars |

- Heat is useful for discovery, not for selection by itself.
- The headline this window happened **off the gain table**: [xAI/SpaceXAI shipped **Grok Build**](agents/grok-build.md), a vendor-official Rust terminal coding agent, to **23.2k stars and 4.4k forks in its first 15 days** — the loudest debut this map has recorded. It is not ranked below because it was not tracked at the start of the window, so it has no comparable 7-day gain yet; tracking starts now and its first real delta lands next week.
- On the table itself, the story is **broad cooling**. Every top-10 gain fell versus last window — [mattpocock/skills](https://github.com/mattpocock/skills) still took a sixth straight #1 but off its record (+11.0k vs +13.6k), [Superpowers](agents/superpowers.md) lost a third of its gain and slipped to #3, and [Codex CLI](agents/codex.md) halved to #6 now that the 100k milestone is behind it. Part of this is arithmetic — this window is 7 days against roughly 8 last time — but the ordering changes are real. [Pi](agents/pi.md) rose to #2 (+4.3k, near 80k) and **[jcode](agents/jcode.md) climbed to #5** (+2.2k, past 12.7k) in its first full window as a profile, validating last week's promotion.
- **[n8n](agents/n8n.md) enters the gain table for the first time at #10** (+973, near 198.5k) — and by only **8 stars** over [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) (+965), which falls off the table entirely from #9. Treat that last seat as a coin-flip, not a signal.
- **New-inclusion decision: [Grok Build](agents/grok-build.md) is added as an in-scope profile.** The vendor-official terminal coding agent (`xai-org/grok-build`, Rust, Apache-2.0, 23.2k) joins the coding-CLI route beside [Codex](agents/codex.md), [Claude Code](agents/claude-code.md), [Kimi Code](agents/kimi-code.md) and [MiMoCode](agents/mimocode.md). Read its governance before adopting: the license is real, but the repo is a periodic export from SpaceXAI's monorepo and **external contributions are not accepted** — source-available, not community-built. Nothing else cleared the bar. Joining the watchlist: [vercel/eve](https://github.com/vercel/eve) (4.2k, Vercel's agent framework, now shipping), [elder-plinius/T3MP3ST](https://github.com/elder-plinius/T3MP3ST) (5.3k, an offensive-security meta-harness — out of scope as a red-team vertical) and [risa-labs-inc/BossConsole](https://github.com/risa-labs-inc/BossConsole) (0.2k, a JVM operator console that drives other agents).

<details>
<summary>More window notes: skills-wave share, OpenClaw, and everything growing outside the top 10</summary>

- The `.claude/skills` wave narrowed again, to three of the top ten (`mattpocock/skills`, `Superpowers`, `anthropics/skills`), as `addyosmani/agent-skills` dropped off. That is the third straight narrowing — 5/10, then 4/10, now 3/10 — and the clearest read is that the wave is consolidating onto its two or three canonical collections rather than cooling outright: `mattpocock/skills` alone still out-gains the rest of the table combined below #4. Policy unchanged: curated collections are tracked as Skills Wave entries, the framework end is covered through [Superpowers](agents/superpowers.md).
- [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) fell off the table at 80.8k (+965), eight stars behind the last seat; [academic-research-skills](https://github.com/Imbad0202/academic-research-skills) stayed off at 39.9k (+964); [TradingAgents](https://github.com/TauricResearch/TradingAgents) reached 94.9k (+809) and remains out of scope as a finance-research vertical.
- [OpenClaw](agents/openclaw.md) remains the absolute leader at 384.4k stars (+0.6k); it is profiled but stays out of the gain-ranked table because reliable week-over-week deltas for a project this large are noisy.
- Continuing to grow but outside the top 10 by gain: [Ruflo](agents/ruflo.md) 66.4k (+0.9k), [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) 32.0k (+0.5k), [CLI-Anything](agents/cli-anything.md) 46.2k (+0.5k), [LangGraph](agents/langgraph.md) 38.4k (+0.5k), [LangChain](agents/langchain.md) 142.8k (+0.5k), [LiteLLM](agents/litellm.md) 54.9k (+0.6k), [Goose](agents/goose.md) 51.9k (+0.4k), [agentmemory](https://github.com/rohitg00/agentmemory) 25.9k (+0.4k), [openhuman](agents/openhuman.md) 35.6k (+0.4k), [CrewAI](agents/crewai.md) 56.3k (+0.3k), [MiMoCode](agents/mimocode.md) 12.5k (+0.2k), [CodeWhale](agents/codewhale.md) 40.2k (+0.2k), [CoStrict](agents/costrict.md) 4.3k (+12, flat).
