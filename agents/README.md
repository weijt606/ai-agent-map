...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 160.5k | +6,609 | Watchlist (Skills Wave) | Held the gain lead for a third straight window — curated `.claude/skills` directory cleared 160k |
| #2&nbsp;(=) | [Superpowers](https://github.com/obra/superpowers) | 249.4k | +5,343 | [Profile](superpowers.md) | Nears 250k — the agentic skills framework keeps compounding |
...
| #4&nbsp;(↓) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 211.3k | +3,572 | [Profile](hermes-agent.md) | Cooled a step to #4 — the in-scope absolute leader cleared 211k |
| #5&nbsp;(↓) | [anthropics/skills](https://github.com/anthropics/skills) | 159.4k | +1,779 | Watchlist (Skills Wave canonical) | Slipped one spot — Anthropic's own reference `.claude/skills` repo, neared 160k |
| #6&nbsp;(↓) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 58.5k | +1,576 | [Profile](codegraph.md) | Steady climb — pre-indexed code knowledge graph cleared 58k |
| #7&nbsp;(↑) | [Pi](https://github.com/earendil-works/pi) | 68.6k | +1,431 | [Profile](pi.md) | Climbed one spot — the Earendil-owned harness cleared 68k |
| #8&nbsp;(↓) | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 91.8k | +1,424 | Not included | Vertical finance-research multi-agent system slipped one spot past 91k — out of scope as a domain vertical |
| #9&nbsp;(↑) | [Codex CLI](https://github.com/openai/codex) | 96.2k | +1,180 | [Profile](codex.md) | Climbed one spot — OpenAI's Codex CLI neared 96k |
