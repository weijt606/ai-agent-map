...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 204.0k | +11,099 | Watchlist (Skills Wave) | Seventh straight window at the gain lead, with the gain up — cleared **200k** |
| #2&nbsp;(=) | [Pi](https://github.com/earendil-works/pi) | 83.9k | +4,245 | [Profile](pi.md) | Held #2 and cleared 83.9k — still the steadiest gainer in the top five |
| #3&nbsp;(=) | [Superpowers](https://github.com/obra/superpowers) | 266.8k | +4,157 | [Profile](superpowers.md) | Held #3 and recovered most of last window's lost gain — cleared 266k |
| #4&nbsp;(=) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 225.7k | +3,852 | [Profile](hermes-agent.md) | Fourth straight window at #4, gain up a quarter — cleared 225k |
| #5&nbsp;(=) | [jcode](https://github.com/1jehuang/jcode) | 16.0k | +3,160 | [Profile](jcode.md) | Held #5 while adding a quarter of its own size in a week (12.8k → 16.0k) |
| #6&nbsp;(=) | [Codex CLI](https://github.com/openai/codex) | 104.1k | +1,914 | [Profile](codex.md) | Held #6 and re-accelerated after the post-100k dip — cleared 104k |
| #7&nbsp;(↑) | [anthropics/skills](https://github.com/anthropics/skills) | 166.4k | +1,549 | Watchlist (Skills Wave canonical) | Up one to #7 — cleared 166k |
| #8&nbsp;(↓) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 64.7k | +1,545 | [Profile](codegraph.md) | Down one on a four-star margin — pre-indexed code knowledge graph cleared 64k |
| #9&nbsp;(new) | [academic-research-skills](https://github.com/Imbad0202/academic-research-skills) | 41.0k | +1,046 | Watchlist (Skills Wave) | Back after two windows off, clearing 41k — re-broadens the skills wave |
| #10&nbsp;(=) | [n8n](https://github.com/n8n-io/n8n) | 199.4k | +960 | [Profile](n8n.md) | Held the last seat by 20 stars, and is about to cross 200k |
