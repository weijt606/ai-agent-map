...
| --- | --- | --- | --- | --- | --- |
| #1&nbsp;(=) | [mattpocock/skills](https://github.com/mattpocock/skills) | 214.3k | +10,291 | Watchlist (Skills Wave) | Eighth straight window at the gain lead, past **214k** — first deceleration in three (−8%) |
| #2&nbsp;(new) | [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills) | 86.4k | +4,664 | Watchlist (Skills Wave) | Off the table last week at +945 — a 4.9× jump straight to #2 |
| #3&nbsp;(↓) | [Pi](https://github.com/earendil-works/pi) | 88.1k | +4,166 | [Profile](pi.md) | Down one on a flat gain — passed, not slowed; cleared 88k |
| #4&nbsp;(↓) | [Superpowers](https://github.com/obra/superpowers) | 270.9k | +4,083 | [Profile](superpowers.md) | Down one, also on a flat gain — cleared 270k |
| #5&nbsp;(↓) | [Hermes Agent](https://github.com/NousResearch/hermes-agent) | 229.2k | +3,496 | [Profile](hermes-agent.md) | Down one as the gain cooled 10% — past 229k |
| #6&nbsp;(new) | [TradingAgents](https://github.com/TauricResearch/TradingAgents) | 97.7k | +2,050 | Out of scope (finance-research vertical) | Biggest window on record (2.6× from +785), closing on 100k |
| #7&nbsp;(=) | [anthropics/skills](https://github.com/anthropics/skills) | 168.4k | +1,999 | Watchlist (Skills Wave canonical) | Held #7 with the gain up 28% — cleared 168k |
| #8&nbsp;(new) | [QM](https://github.com/yc-software/qm) | 13.2k | +1,756 | [Profile](qm.md) | First full window since being profiled: +15% of its own size (11.4k → 13.2k) |
| #9&nbsp;(↓) | [Codex CLI](https://github.com/openai/codex) | 105.4k | +1,382 | [Profile](codex.md) | Down three, giving back last window's rebound (−28%) — cleared 105k |
| #10&nbsp;(↓) | [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 66.0k | +1,337 | [Profile](codegraph.md) | Down two, holding the last seat by 53 stars — cleared 66k |
