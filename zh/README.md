...
| #4 | [oh-my-claudecode](agents/oh-my-claudecode.md) | 27.6k | +5,935 | 已收录 | 围绕 Claude Code 的高热度 orchestration layer |
| #5 | [AI Edge Gallery](agents/ai-edge-gallery.md) | 20.3k | +3,796 | 已收录，但附带范围说明 | 更像端侧 assistant 沙盒，不是 coding-first agent |
