...
| --- | --- | --- | --- | --- | --- |
| #1 | [Hermes Agent](agents/hermes-agent.md) | 118.2k | +58,500 | 已收录 | 自托管多 agent 环境，仍是这次快照里增长最猛的项目 |
| #2 | [OpenScreen](https://github.com/siddharthvaddem/openscreen) | 32.9k | +3,800 | 不收录 | 仍然热门，但本质上是录屏 / 演示工具，不是 agent |
| #3 | [oh-my-codex](agents/oh-my-codex.md) | 26.1k | +3,500 | 已收录 | 围绕 Codex 的工作流和 orchestration layer，仍在爬升 |
| #4 | [oh-my-claudecode](agents/oh-my-claudecode.md) | 31.4k | +2,800 | 已收录 | 围绕 Claude Code 的工作流和 orchestration layer |
| #5 | [AI Edge Gallery](agents/ai-edge-gallery.md) | 22.1k | +1,400 | 已收录，但附带范围说明 | 更像端侧 assistant 沙盒，不是 coding-first agent |
| #6（新） | [Mercury Agent](agents/mercury-agent.md) | 1.4k | +1,400 | 已收录 | 全新条目（2026-04-20 创建）——主打 CLI 和 Telegram 的权限硬化自托管 agent |
