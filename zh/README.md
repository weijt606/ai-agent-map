...
| 通用自主 agent | [AutoGPT](agents/autogpt.md) | 想用可视化方式搭建通用自主任务 agent 的人 |
| 自建系统 | [LangChain](agents/langchain.md), [LangGraph](agents/langgraph.md), [CrewAI](agents/crewai.md), [LlamaIndex](agents/llamaindex.md) | 想自己搭 agent 平台的团队 |
| 运行时 & 工具 | [n8n](agents/n8n.md), [MemGPT](agents/memgpt.md) | 需要带 AI agent 的工作流自动化，或有状态 agent 持久记忆的团队 |
