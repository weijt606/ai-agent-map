...
到目前为止的主线：早期榜单由 Hermes Agent 统治，5 月底起 `.claude/skills` 浪潮接管，6 月中以后前三名几乎完全在 curated skills 合集之间轮换。2026-08-27 这个窗口是这个模式第一次被打破——[Codex CLI](../agents/codex.md) 靠一次厂商降价拿到热度榜 #2，这是 6 月以来第一次由非 skills 项目占住增量榜前两席。
